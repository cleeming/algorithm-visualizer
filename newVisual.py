...
# This class handles all the global variables I need to access throughout the project
class DrawInformation:
    # Colors used for the visualizer
    BLACK = 0, 0, 0
    WHITE = 255, 255, 255
    BLUE = 128, 128, 255
    GREEN = 0, 255, 0
    ...
    # Creating a gradient that allows each candle stick to be a slightly different grey
    GRADIENTS = [
        (128, 128, 255),
        (160, 160, 255),
        (192, 192, 255)
    ...
    # Initializing these padding variables so I dont have to hardcode them into the functions,
    # making them easily changeable.
    SIDE_PAD = 100
    TOP_PAD = 150

    # This function initializes the game window and takes in a width, height, and the list we want to sort.
    # Doing this allows us to change the width and height later on if we wish to. 
